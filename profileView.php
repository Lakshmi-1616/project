    ...
    <div class="inner">
        <div class="box">
            <header>
                <center>
                    <span>
                        <img src="/AgroCulture/images/profileImages/profile0.png?<?php echo mt_rand(); ?>"
                             class="image-circle img-responsive" height="200%">
                    </span>
                    <br>
            ...
            <div class="12u$" style="text-align: center; margin-left: 16em;">
