...
<body>
	...
	<section id="main" class="wrapper style1 align-center" >
		<div class="container">
			<h2>Welcome to the digital market</h2>
							...
							<div class="col-sm-2">
								<div class="select-wrapper" style="width: auto" >
									<select name="type" id="type" required style="background-color:white;color: black;">
										...
										<option value="grain" style="color: black;">product</option>
										<option value="grain" style="color: black;">service</option>
									</select>
							  	</div>
							</div>
							<div class="col-sm-2">
			...
			<section id="two" class="wrapper style2 align-center">
				...
				<?php
					if(!isset($_GET['type']) || $_GET['type'] == "all") {
						...
						$sql = "SELECT * FROM fproduct WHERE pcat = 'product'";
					} elseif($_GET['type'] == "service") {
						$sql = "SELECT * FROM fproduct WHERE pcat = 'service'";
					}
						...
						<section>
							...
							<div style="text-align: left">
								<blockquote>
									...
									<?php echo "Seller Name: ".$row['seller_name']; ?><br>
